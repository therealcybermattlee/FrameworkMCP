...
export class FrameworkHttpServer {
  ...
  private setupRoutes(): void {
    ...
    this.app.get('/api', (req, res) => {
      res.json({
        ...
        version: '1.1.3',
        description: 'HTTP API for vendor capability assessment against CIS Controls Framework',
        endpoints: {
  ...
  public start(): void {
    this.app.listen(this.port, '0.0.0.0', () => {
      console.log(`🚀 Framework MCP HTTP Server v1.1.3 running on port ${this.port}`);
